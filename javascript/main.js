...
const password_el = document.querySelector(
  " .projects .boxSeven label #password"
);
const length_el = document.querySelector(".projects .boxSeven #length");
const uppercase_el = document.querySelector(
  ".projects .boxSeven label #uppercase"
);
const lowercase_el = document.querySelector(
  ".projects .boxSeven label #lowercase"
);
const numbers_el = document.querySelector(".projects .boxSeven label #numbers");
const symbols_el = document.querySelector(".projects .boxSeven label #symbols");

const generate_btn = document.querySelector(".projects .boxSeven #generate");
generate_btn.addEventListener("click", GeneratePassword);
const copy_btn = document.querySelector(".projects .boxSeven #copy");
